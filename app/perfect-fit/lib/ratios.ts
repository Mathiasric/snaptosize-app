...
export type PFRatio = { id: string; label: string; w: number; h: number; group: string; count: number }

// `count` = how many print sizes are in that ratio's pack (mirrors the Runner's PACK_SIZES).
